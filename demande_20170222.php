...
if ($_REQUEST['service'] === 'get_regle_valideur') {
	...
	//http://gopaas.fr/services/altarea/recrutement/template_auto/demande/demande.php?service=get_regle_valideur&societe=Cogedim+Vente&type_contrat=STAGIAIRE&duree=plus+de+5+mois&direction=CV0G38C18&motif_recrutement=&metier=&transverse=Non
	// Script::$db->debug = true;
	// ! attention le nom de la table regle_validateur n'a pas été renommé en regle_valideur
	/*
	ErrorHandler::info("

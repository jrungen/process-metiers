...
if($_REQUEST['mode']=='createItems'){
	...
	try{
		...
		// Requete INSERT INTO
		   $query = "INSERT INTO 
					a00personnephysique
					(cle, r04roletiers, r03typemouvement, a00civilite, a00nom, a00prenom, a00adresse, a00complement, a00codepostal, a00ville,a00nationalite, a00datenaissance, a00departementnaissance, a00lieunaissance, a00numerosecu,a00clesecu, a00actif, creation_par, date_creation, heure_creation, modification_par, 	
date_modification, heure_modification  ) 
					values
	...
	try{
		...
		$query = "INSERT INTO 
						a05typemouvement
					(cle, a05dateeffet, a05cochsituationcourant, a00personnephysique, r03typemouvement, r00societes, r04roletiers, creation_par, date_creation, heure_creation, modification_par, 	
date_modification, heure_modification) 
					values
					('".$mvt_cle."', '".$data_candidat[0]->t01_30_date_debut_contrat."', 'Oui', '".$personnephysique_cle."', 'TM001', '".$data_candidat[0]->cs00societes."', 'ROL001', 'candidat', CURDATE(),CURTIME(), 'candidat', CURDATE(),  CURTIME()  )
					";
